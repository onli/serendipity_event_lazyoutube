        ...
        for($i = 0; $i < $search_elements; $i++) {
            $text = preg_replace_callback($search[$i], function ($matches) {
                            ...
                            return '<iframe
                                ...
                                srcdoc="<style>*{padding:0;margin:0;overflow:hidden}html,body{height:100%}img,span{position:absolute;width:100%;top:0;bottom:0;margin:auto}span{height:1.5em;text-align:center;font:48px/1.5 sans-serif;color:white;text-shadow:0 0 0.5em black}</style><a href=https://www.youtube-nocookie.com/embed/' . $videoid . $params . '><img width=560 height=420 loading=lazy src=https://img.youtube.com/vi/' . $videoid .'/hqdefault.jpg><span>▶</span></a>"
                                frameborder="0"
